    ...
    stages{
        ...
        stage("get artifact from nexus"){
            steps{
                ...
                curl http://34.237.124.164:8081/repository/${nexustesting_application}/shoppingcart/shoppingcart/${VERSION}/shoppingcart-${VERSION}.war --output shoppingcart-2.0.war'''
            }
        }
    }
}
